        ...
        <div className='h-full flex flex-col bg-black'>
            ...
            <div className='flex-1 flex flex-col overflow-hidden p-2'>
                ...
                <div className='bg-[#121212] rounded-lg flex-1 flex flex-col overflow-hidden'>
                    ...
                    <div className='px-2 overflow-x-auto pb-4 scrollbar-hidden'>
                        <div className='inline-flex gap-2'>
                            <button onClick={() => {
                                navigate('/liked');
                                onClose?.();
                            }} 
                            className='min-w-[160px] p-4 bg-gradient-to-br from-purple-800 to-blue-900 
                                rounded-lg hover:opacity-90 transition-all group'>
                                <h3 className='font-bold text-xl mb-1 text-left'>Liked Songs</h3>
                                <p className='text-sm text-gray-300 text-left'>{likedSongs.length} liked songs</p>
                            </button>
                            ...
                            {playlists.map(playlist => (
                                <div
                                    ...
                                    className='min-w-[160px] p-4 bg-[#282828] rounded-lg hover:bg-[#333333] 
                                        transition-all text-left group relative cursor-pointer'
                                >
                                    <div className='mb-8'>
